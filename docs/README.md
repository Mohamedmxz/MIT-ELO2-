...
- Designed with a Sudan-inspired palette and responsive layout.

Deploy:

- This is intended to work on GitHub Pages. With site at:
  <https://mohamedmxz.github.io/MIT-ELO2-/>
  make sure index.html is at the published branch root (typically gh-pages or main depending on your Pages config).
